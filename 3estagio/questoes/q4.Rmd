...
Podemos ver ainda que obtivemos um R² ajustado de 0,92, e vemos que a estatística F tem um p-value muito baixo, assim com muita significância podemos afirmar que o modelo é melhor que o modelo nulo (ou seja, simplesmente prever utilizando a média).
...
Obtivemos um R² de aproximadamente 0.92, indicando que temos de fato um bom modelo.
