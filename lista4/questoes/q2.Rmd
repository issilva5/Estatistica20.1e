...
$\overline{p} \sim N(0,53; \frac{0,53 \ . \ 0,47}{150}$

E a probabilidade de que em uma nova pesquisa o candidato tenha pelo menos 63% das intenções de voto é dada por:

$P(\overline{p} \geq 0,63) = P(Z \geq \frac{0,63 - 0,53}{\frac{\sqrt{0,2491}}{\sqrt{150}}}) = $


$ = P(Z \geq \frac{0,1}{\frac{0,4991}{\sqrt{150}}}) = P(Z \geq 0,04)}) = 1 - P(Z < 0,04) = 1 - 0,5160 = 0,48$

Como a probabilidade é de 48%, não é razoável o candidato fazer a afirmação.
